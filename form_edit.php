                ...
                <form action="proses_edit.php" method="POST">
                    ...
                    <div class="layanan-container">
                        <div class="item-layanan">
                            ...
                            <input type="checkbox" name="layanan_penginapan" id="layanan_penginapan" value="<?php echo $harga_penginapan; ?>" <?php echo renderLayanan($akomodasi);?>/>
                        </div>
                        <div class="item-layanan">
                            ...
                            <input type="checkbox" name="layanan_transportasi" id="layanan_transportasi" value="<?php echo $harga_transportasi; ?>" <?php echo renderLayanan($transportasi);?>/>
                        </div>
                        <div class="item-layanan">
                            ...
                            <input type="checkbox" name="layanan_makan" id="layanan_makan" value="<?php echo $harga_makan; ?>" <?php echo renderLayanan($makanan);?>/>
                        </div>
                    </div>
...
$(document).ready(function(){
    ...
    if(jumlah_peserta < 1){
        ...
        $('#jumlah_peserta').val("1"); jumlah_peserta = $('#jumlah_peserta').val();
    }

    if(jumlah_hari < 1){
        alert("jumlah hari minimal 1");
        $('#jumlah_hari').val("1"); jumlah_hari = $('#jumlah_hari').val();
    }

        if(parseInt(harga_transportasi) == 0){
            alert("Wajib menyertakan Paket Transportasi"); $('#layanan_penginapan').prop('checked', true); harga_transportasi = $('#layanan_transportasi').val();
        }
